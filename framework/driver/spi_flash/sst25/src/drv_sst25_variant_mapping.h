/*******************************************************************************
  SST25 Driver Variant Mapping

  Company:
    Microchip Technology Inc.

  File Name:
    drv_sst25_variant_mapping.h
...
#ifndef _DRV_SST25_FEATURE_MAPPING_H
#define _DRV_SST25_FEATURE_MAPPING_H
...
*/
...
#if (DRV_SST25_HARDWARE_WRITE_PROTECTION_ENABLE == true)
    ...
    #define _DRV_SST25_IsWriteProtectEnabled()      true
#else
    #define _DRV_SST25_IsWriteProtectEnabled()      false
...
*/
#if (DRV_SST25_HARDWARE_HOLD_ENABLE == true)
    ...
    #define _DRV_SST25_IsHoldEnabled()    true
#else
    #define _DRV_SST25_IsHoldEnabled()    false
    
#endif

#if defined (DRV_SST25_SYS_FS_REGISTER)
#define DRV_SST25_RegisterWithSysFs(x, y, z) SYS_FS_MEDIA_MANAGER_Register((SYS_MODULE_OBJ)x, (SYS_MODULE_INDEX)y, &z, SYS_FS_MEDIA_TYPE_SPIFLASH)
#else
#define DRV_SST25_RegisterWithSysFs(x, y, z)
#endif
...
#endif //_DRV_SST25_FEATURE_MAPPING_H
