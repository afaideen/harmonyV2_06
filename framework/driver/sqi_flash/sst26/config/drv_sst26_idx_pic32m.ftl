...
config DRV_SST26_MEDIA_START_ADDRESS_IDX${INSTANCE}
    int "SQI Flash Media Start Address"
    depends on USE_DRV_SST26
#    depends on USE_DRV_NVM_MEDIA || DRV_NVM_DRIVER_TYPE = "BLOCK_DRIVER"
    default 4096	# if DRV_NVM_DRIVER_TYPE = "BETA"
#    default 0x9D010000 if DRV_NVM_DRIVER_TYPE = "BLOCK_DRIVER"
    ---help---
      IDH_HTML_DRV_SST26_MEDIA_START_ADDRESS
    ---endhelp---
