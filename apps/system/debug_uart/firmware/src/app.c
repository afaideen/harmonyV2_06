...
//        DRV_USART_WriteByte(appData.handleUSART0, *buffer++);
//	}
    /* transmit till NULL character is encountered */
	while(*buffer != '\0')
	{
 ...
 ******************************************************************************/    
    ...
    putsUART("Let's test debug_uart!\r\n");
}
...
//            }
        ...
        case APP_STATE_DONE:
            putsUART("\r\nSo uart static actually can also be used...");
            putsUART("\r\nCongratulation! It's successful...Let's Celebrate!");
            appData.state += 2;
