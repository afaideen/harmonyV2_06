...
#define APP_FLASH_BASE_ADDRESS  (0x9D000000 + 0x14000)
//#define APP_FLASH_BASE_ADDRESS  (0x9D000000 + 0x14000)//(0x9D000000 + 0x13000)
//#define APP_FLASH_END_ADDRESS           (0x9D000000 + 0x80000 - 1)
#define APP_FLASH_END_ADDRESS           (0x9D000000 + BMXPFMSZ - 1)

/* Address of  the Flash from where the application starts executing */
/* Rule: Set APP_FLASH_BASE_ADDRESS to _RESET_ADDR value of application linker script*/
#define APP_RESET_ADDRESS               (APP_FLASH_BASE_ADDRESS + 0x1000)
...
#define TCPIP_NETWORK_DEFAULT_HOST_NAME_IDX0				"MCHPBOARD"
...
#define TCPIP_NETWORK_DEFAULT_DNS_IDX0					"192.168.1.111"
